...
class HuffmanCoding:
    ...
    def compress(self):
        ...
        with open(self.path, 'r+') as file, open(output_path, 'wb') as output:
            ...
            #Construct the binary node from the heap
            self.__buildTree()

            #Construct he codes from binary tree
            self.__buildCodes()
...
if __name__ == '__main__':
    path = 'C:/Users/Writobrata/Documents/Python Programs/Programming/.idea/Coding Ninja/Huffman Coding/sample.txt'
